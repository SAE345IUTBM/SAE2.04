...
(NULL, 'Dirt Jump Dave', 31, 8, 1100, 'Cannondale_1.png', 4219, 1, 3, 1),
(NULL, 'F-Si Carbon 5', 31, 8, 1800, 'Cannondale_2.png', 3830, 1, 4, 1),
(NULL, 'Team Machine SLR', 29, 7.1, 8999, 'BMC_1.png', 737, 2, 3, 3),
(NULL, 'Road Machine', 29, 7.1, 4899, 'BMC_2.png', 1152, 2, 8, 3),
...
(NULL, 'E-ST 500', 27.5, 22.2, 1299, 'Rockrider_3.jpg', 3840, 7, 6, 1),
(NULL, 'MARLIN 8 SRAM SX', 27.5, 13.2, 1024, 'Trek_1.jpg', 7108, 8, 7, 1),
(NULL, 'Verve+ 3', 29, 24, 3000, 'Trek_2.png', 1982, 8, 3, 2);
