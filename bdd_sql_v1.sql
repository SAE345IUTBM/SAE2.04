DROP TABLE IF EXISTS commande, etat, panier, ligne_commande, user, Velo, Fournisseur, Type_velo, Couleur, Marque;
...
(NULL, 'Dirt Jump Dave', 31, 8, 1100, 'Cannondale_1.png', 1, 3, 1, 2, 4),
(NULL, 'F-Si Carbon 5', 31, 8, 1800, 'Cannondale_2.png', 1, 4, 1, 3, 4),
(NULL, 'Team Machine SLR', 29, 7.1, 8999, 'BMC_1.png', 2, 3, 3, 5, 3),
(NULL, 'Road Machine', 29, 7.1, 4899, 'BMC_2.png', 2, 8, 3, 6, 3),
(NULL, 'Edge 3.9', 29, 11, 599, 'Lapierre_1.jpg', 3, 3, 1, 3, 1),
(NULL, 'Xelius 8.0', 31, 9, 5399, 'Lapierre_2.png', 3, 7, 3, 5, 3),
(NULL, 'Riverside 500', 26, 15, 299, 'Btwin_1.jpg', 4, 3, 2, 1, 2),
(NULL, 'GAN Dura-Ace', 29, 10, 4999, 'Pinarello_1.jpg', 5, 1, 3, 3, 3),
(NULL, 'X2', 28, 11, 399, 'Nakamura_1.png', 6, 1, 2, 2, 1),
(NULL, 'E-ST 100', 27.5, 22.5, 999, 'Rockrider_1.jpg', 7, 6, 1, 1, 1),
(NULL, 'E-ST 520', 27.5, 22.7, 1799, 'Rockrider_2.jpg', 7, 2, 1, 1, 1),
(NULL, 'E-ST 500', 27.5, 22.2, 1299, 'Rockrider_3.jpg', 7, 6, 1, 1, 1),
(NULL, 'MARLIN 8 SRAM SX', 27.5, 13.2, 1024, 'Trek_1.jpg', 8, 7, 1, 6, 1),
(NULL, 'Verve+ 3', 29, 24, 3000, 'Trek_2.png', 7, 3, 2, 4, 1);
